...
var weaponData = [...]struct {
	...
	MiningLaser: {'J', "Mining Laser", 8, SingleTurret, WorldScale, 500_000, 0, 0, Electronic, true},
	...
	PlasmaGun:   {'P', "Plasma Gun", 11, SingleBarbette, WorldScale, 1_000_000, 0, 0, Electronic | Gravitic, true},
	FusionGun:   {'F', "Fusion Gun", 12, SingleBarbette, WorldScale, 1_500_000, 0, 0, Electronic | Gravitic, true},

	SlugThrower:     {'B', "Slug Thrower", 9, SingleTurret, WorldScale, 200_000, 0, 0, Electronic, true},
	SalvoRack:       {'V', "Salvo Rack", 10, Bay, WorldScale, 10_000_000, 0, 0, Electronic | Magnetic, true},
	RailGun:         {'R', "Rail Gun", 12, Bay, SpaceScale, 12_000_000, 0, 0, Electronic | Magnetic, false},
	MissileLauncher: {'M', "Missile", 7, SingleTurret, SpaceScale, 2_000_000, 0, 0, Electronic, false},
	KKMissile:       {'N', "KK Missile", 10, Bay, SpaceScale, 3_000_000, 0, 0, Electronic, false},
	AMMissile:       {'X', "AM Missile", 20, SingleBarbette, SpaceScale, 5_000_000, 0, 0, Electronic, false},

	JumpDamper:     {'T', "Jump Damper", 14, SingleBarbette, WorldScale, 15_000_000, 0, 0, Electronic, false},
	TractorPressor: {'U', "Tractor Pressor", 16, SingleBarbette, WorldScale, 5_000_000, 0, 0, Electronic, false},
	Inducer:        {'H', "Inducer", 17, SingleTurret, WorldScale, 1_000_000, 0, 0, Electronic, false},
	Disruptor:      {'W', "Disruptor", 18, SingleBarbette, SpaceScale, 15_000_000, 0, 0, Electronic | Gravitic, false},
	Stasis:         {'E', "Stasis", 21, SingleTurret, SpaceScale, 5_000_000, 0, 0, Electronic, false},

	DataCaster: {'D', "DataCaster", 10, SingleTurret, WorldScale, 1_000_000, 0, 0, Electronic, false},
	...
	CommCaster: {'C', "CommCaster", 8, SingleTurret, SpaceScale, 5_000_000, 0, 0, Electronic, false},
	// The Hybrid and the PA are the two dual-scale weapons ("S=7* R=7*").
	HybridSLM:     {'Y', "Hybrid SLM", 10, SingleTurret, EitherScale, 1_000_000, 0, 0, Electronic, true},
	ParticleAccel: {'A', "PA", 11, SingleBarbette, EitherScale, 2_500_000, 0, 0, Electronic | Magnetic, false},
	MesonGun:      {'G', "Meson Gun", 13, Main, SpaceScale, 5_000_000, 0, 0, Electronic | Gravitic, false},
}

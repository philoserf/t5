...
func TestStringOutOfRangeDoesNotPanic(t *testing.T) {
	...
	p := Profile{Starport: 'A', Size: 40, Atmosphere: 8, Hydrographics: 8, Population: 8, Government: 9, Law: 9, TechLevel: 12}
...
func TestStringEHexFields(t *testing.T) {
	...
	p := Profile{Starport: 'X', Size: 10, Atmosphere: 15, Hydrographics: 10, Population: 12, Government: 15, Law: 18, TechLevel: 10}

...
// target the usual way (a positive mod makes success easier). This resolves
// through internal/task rather than against the dice primitives directly —
// see root CLAUDE.md's internal/task section for why.
//
...
// — rather than passing the Difficulty itself. See CLAUDE.md for why the
// parameter stays a raw count rather than narrowing to a task.Difficulty.
//

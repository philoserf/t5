...
var tradeGoodsColumns = map[string][6]goodsBlock{
	...
	"De": {
		...
		{
			"Samples",
			[6]string{"Archeologicals", "Fauna", "Flora", "Minerals", "Ephemerals", "Polymers"},
		},
		{
			"Pharma",
			[6]string{
		...
		{
			"Rares",
			[6]string{"Excretions", "Flavorings", "Nectars", "Pelts", "ANIFX Dyes", "Seedstock"},
		},
		{
			"Uniques",
			[6]string{"Pheromones", "Artifacts", "Sparx", "Repulsant", "Dominants", "Fossils"},
		},
	},
	"Fl": {
		{
	...
	"Ic": {
		...
		{
			"Samples",
			[6]string{"Archeologicals", "Fauna", "Flora", "Minerals", "Luminescents", "Polymers"},
		},
		{
			"Pharma",
			[6]string{
	...
	"Po": {
		...
		{
			"Entertainments",
			[6]string{"Art", "Recordings", "Writings", "Tactiles", "Osmancies", "Wafers"},
		},
		{
			"Novelties",
			[6]string{
		...
		{
			"Rares",
			[6]string{"Gemstones", "Antiques", "Collectibles", "Allotropes", "Spices", "Seedstock"},
		},
		{
			"Uniques",
			[6]string{
	...
	"Ri": {
		...
		{
			"Rares",
			[6]string{"Delicacies", "Spices", "Tisanes", "Nectars", "Pelts", "Variable Tattoos"},
		},
		{
			"Uniques",
			[6]string{
		...
		{
			"Entertainments",
			[6]string{"Edutainments", "Recordings", "Writings", "Tactiles", "Osmancies", "Wafers"},
		},
	},
	"Va": {
		{
		...
		{
			"Scrap/Waste",
			[6]string{"Obsoletes", "Used Goods", "Reparables", "Plutonium", "Metals", "Sludges"},
		},
	},
	"CpCsCx": {
		{

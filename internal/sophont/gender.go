...
var genderColumns = map[GenderStructure][]string{
	Solitaire: {"Solo", "Solo", "Solo", "Solo", "Solo", "Solo", "Solo", "Solo", "Solo", "Solo", "Solo"},
	Dual:      {"Female", "Female", "Female", "Female", "Male", "Female", "Male", "Male", "Male", "Female", "Male"},
	EAB:       {"Egg Donor", "Egg Donor", "Egg Donor", "Activator", "Egg Donor", "Activator", "Bearer", "Bearer", "Bearer", "Activator", "Bearer"},

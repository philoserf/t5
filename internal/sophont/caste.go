...
var casteColumns = map[CasteStructure][]string{
	...
	Economic: {"Innovator", "=Gender", "Guard", "Researcher", "Artisan", "Laborer", "Craftsman", "Clerk", "Manager", "=Special", "Entrepreneur"},
	Family:   {"Healer", "=Gender", "Defender", "Caregiver", "Caregiver", "Breadwinner", "Breadwinner", "Breadwinner", "Uncle", "=Special", "Leader"},
	Military: {"Medic", "=Gender", "Aide", "Scout", "Specialist", "Soldier", "Technician", "Warrior", "Leader", "=Special", "Staff"},

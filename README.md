...
skill eligibility, and mustering out) for six careers, each selected with its own
`-career` value: the Scout, the fixed-characteristic Rogue, the rankless Agent,
and three ranked armed-forces careers — the Soldier, Marine, and Spacer — whose
enlisted/officer ladders, Commissions, and Medal-boosted promotions exercise the
rank engine (e.g. `-career soldier`). The remaining education institutions, the
